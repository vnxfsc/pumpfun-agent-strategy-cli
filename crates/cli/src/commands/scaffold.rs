...
use crate::{
    ...
    commands::{
        ...
        inspect::{
            ...
            report::{CloneReportOutput, ParamsSeed, analyze_clone_candidates, build_clone_report},
        },
    },
...
pub async fn clone_scaffold(args: CloneScaffoldArgs) -> Result<()> {
    ...
    let report = build_clone_report(
        ...
        export_summary
            .as_ref()
            .map(crate::commands::inspect::report::CloneReportExportSummary::from),
    );
...
mod tests {
    ...
    fn sample_clone_report() -> CloneReportOutput {
        CloneReportOutput {
            ...
            base_fit: crate::commands::inspect::report::FitSummary {
            ...
            runner_up: crate::commands::inspect::report::FitSummary {
